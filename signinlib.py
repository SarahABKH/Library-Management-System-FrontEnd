...
def user_enter(event):
    if usernameEntry.get()=='Librarian ID':
...
usernameLabel=Label(frame,text='Librarian Id',font=('Microsoft Yahei UI Light',10,'bold'),bg='white',fg='#6B764C')
usernameLabel.grid(row=3,column=0,sticky='w',padx=25,pady=(10,0))
usernameEntry=Entry(frame,width=30,font=('Microsoft Yahei UI Light',10,'bold'),fg='white',bg='#6B764C')
usernameEntry.grid(row=4,column=0,sticky='w',padx=25) 
usernameEntry.insert(0,'Librarian ID')
...
passwordEntry=Entry(frame,width=25,font=('Microsoft Yahei UI Light',10,'bold'),fg='white',bg='#6B764C')
...
loginButton=Button(frame,text='Login',font=('Open Sans',16,'bold'),fg='white',bg='#6B764C',activeforeground='white',activebackground="firebrick1",cursor='hand2',border=0,width=19,command=connect_database)
