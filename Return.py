...
ADD_BOOK=Label(mainpage_window,text='RETURN A BOOK',font=('Microsoft Yahei UI Light',30,'bold'),fg='White',bg='#CBC4B6')
...
AddButton=Button(frame,text='RETURN BOOK',font=('Open Sans',16,'bold'),bd=0,bg='#6B764C',fg='white',activeforeground='white',width=17 )
