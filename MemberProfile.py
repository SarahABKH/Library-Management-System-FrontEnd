...
mainpage_window.title('MEMBER PROFILE')
...
ADD_BOOK=Label(mainpage_window,text='MEMBER PROFILE',font=('Microsoft Yahei UI Light',30,'bold'),fg='White',bg='#CBC4B6')
ADD_BOOK.place(x=670,y=40)
...
drop.config(bg = "#CBC4B6",font=('Microsoft Yahei UI Light',15,'bold'),fg="white")
drop.place(x=1050,y=200)

NAMEEntry=Entry(mainpage_window,width=30,font=('Microsoft Yahei UI Light',15,'bold'),fg='white',bg='#CBC4B6')
NAMEEntry.place(x=1050,y=250)

SearchButton=Button(mainpage_window,text='SUBMIT',font=('Microsoft Yahei UI Light',16,'bold'),bd=0,bg='#CBC4B6',fg='white',activeforeground='white',width=17 )
